...
const MenProductDetail = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      title: 'RTW | SHERWANI',
      category: 'SILK | PRINTED',
      sku: 'MS89-9-2P21-MS89-9-2P21-M',
      price: 'PKR 8,990',
      image: '/images/men.webp',
      color: 'Indigo',
      fabric: 'SILK',
      description: 'Luxurious silk sherwani with printed design. Perfect for grand celebrations.',
      careInstructions: ['Dry clean only', 'Do not use bleach', 'Store carefully']
    },
    {
      id: 22,
      title: 'RTW | SHIRT & CULOTTE',
      category: 'CAMBRIC | PRINTED',
      sku: 'MS89-9-2P22-MS89-9-2P22-M',
      price: 'PKR 3,490',
      image: '/images/men.webp',
      color: 'Turquoise',
      fabric: 'CAMBRIC',
      description: 'Stylish cambric shirt and culotte set with printed pattern. Great for casual occasions.',
      careInstructions: ['Machine wash', 'Do not use bleach', 'Can be ironed']
    },
    {
      id: 23,
      title: 'RTW | KURTA & TROUSER',
      category: 'LAWN | EMBROIDERED',
      sku: 'MS89-9-2P23-MS89-9-2P23-M',
      price: 'PKR 5,690',
      image: '/images/men.webp',
      color: 'Peach',
      fabric: 'LAWN',
      description: 'Elegant lawn kurta and trouser set with embroidery work. Perfect for festive occasions.',
      careInstructions: ['Machine wash', 'Do not use bleach', 'Can be ironed']
    },
    {
      id: 24,
      title: 'RTW | SHIRT',
      category: 'COTTON | PRINTED',
      sku: 'MS89-9-2P24-MS89-9-2P24-M',
      price: 'PKR 2,190',
      image: '/images/men.webp',
      color: 'Sage',
      fabric: 'COTTON',
      description: 'Comfortable cotton shirt with printed design. Perfect for everyday wear.',
      careInstructions: ['Machine wash', 'Do not use bleach', 'Can be ironed']
    },
    {
      id: 25,
      title: 'RTW | SHERWANI',
      category: 'SILK | EMBROIDERED',
      sku: 'MS89-9-2P25-MS89-9-2P25-M',
      price: 'PKR 13,990',
      image: '/images/men.webp',
      color: 'Ruby',
      fabric: 'SILK',
      description: 'Exquisite silk sherwani with intricate embroidery. Perfect for royal celebrations.',
      careInstructions: ['Dry clean only', 'Do not use bleach', 'Store carefully']
    },
    {
      id: 26,
      title: 'RTW | SHIRT & TROUSER',
      category: 'LAWN | PRINTED',
      sku: 'MS89-9-2P26-MS89-9-2P26-M',
      price: 'PKR 3,890',
      image: '/images/men.webp',
      color: 'Coral',
      fabric: 'LAWN',
      description: 'Comfortable lawn shirt and trouser set with printed design. Ideal for casual outings.',
      careInstructions: ['Machine wash', 'Do not use bleach', 'Can be ironed']
    },
    {
      id: 27,
      title: 'RTW | KURTA',
      category: 'CAMBRIC | EMBROIDERED',
      sku: 'MS89-9-2P27-MS89-9-2P27-M',
      price: 'PKR 5,190',
      image: '/images/men.webp',
      color: 'Plum',
      fabric: 'CAMBRIC',
      description: 'Beautiful cambric kurta with embroidered details. Perfect for cultural events.',
      careInstructions: ['Hand wash', 'Do not use bleach', 'Dry clean recommended']
    },
    {
      id: 28,
      title: 'RTW | SHIRT & CULOTTE',
      category: 'COTTON | PRINTED',
      sku: 'MS89-9-2P28-MS89-9-2P28-M',
      price: 'PKR 2,990',
      image: '/images/men.webp',
      color: 'Cream',
      fabric: 'COTTON',
      description: 'Comfortable cotton shirt and culotte set with printed design. Great for casual wear.',
      careInstructions: ['Machine wash', 'Do not use bleach', 'Can be ironed']
    }
  ];
